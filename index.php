...
<?php include "includes/gallery.php";?>
   ...
   <?php include "includes/coverage.php";?>
    ...
    <section id="coverage">
        <h2 class="section-title">P2P Internet Coverage</h2>
            ...
            ?>
                <div class="pricing-card <?php echo $is_popular ? 'popular' : ''; ?>">
                    ...
                    <ul class="pricing-features">
                        <?php foreach ($display_inclusions as $inclusion): ?>
                    ...
                    <button class="cta-button view-plan-btn" 
...
<!-- Inclusions Modal -->
<div class="modal fade" id="inclusionsModal" tabindex="-1" aria-hidden="true">
